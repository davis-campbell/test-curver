This application is meant to help teachers and professors to curve their exams using a normal distribution. It accepts the scores in a csv file of the following format:
